  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: GetBuilder<ProductController>(builder: (productController) {
        ...
        String testing =
            '${widget.isCampaign ? Get.find<SplashController>().configModel.baseUrls.campaignImageUrl : UtilFunctions.startsWitHTTP(widget.product.image) ? widget.product.image : Get.find<SplashController>().configModel.baseUrls.productImageUrl}/${widget.product.image}';
        if (kDebugMode) {
          print("ProductVeg: ${widget.product.veg}");
        }
