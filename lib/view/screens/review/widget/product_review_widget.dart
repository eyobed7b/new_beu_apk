                    ...
                    return Container(
                      ...
                      child: Column(children: [
                        ...
                        Row(
                          children: [
                            ...
                            Expanded(
                              ...
                              children: [
                                Text(
                                    widget.orderDetailsList[index].foodDetails
                                        .name,
                                    style: sfMedium,
                                    maxLines: 2,
                        ...
                        SizedBox(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, i) {
                              return InkWell(
                                child: Icon(
                                  productController.ratingList[index] < (i + 1)
                                      ? Icons.star_border
                                      : Icons.star,
                                  size: 25,
                                  color: productController.ratingList[index] <
                                          (i + 1)
                        ...
                        MyTextField(
                          ...
                          onChanged: (text) =>
                              productController.setReview(index, text),
                        ),
                        SizedBox(height: 20),
                        ...
                        Padding(
                          ...
                          child: !productController.loadingList[index]
                              ? CustomButton(
                                  buttonText:
                                      productController.submitList[index]
                                          ? 'submitted'.tr
                                          : 'submit'.tr,
                                  onPressed: productController.submitList[index]
                                      ? null
                                      : () {
