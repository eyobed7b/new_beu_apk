          ...
          : Column(children: [
              ...
              Row(children: [
                ClipOval(
                    child: CustomImage(
                  image:
                      '${_takeAway ? UtilFunctions.startsWitHTTP(track.restaurant.logo) ? "" : Get.find<SplashController>().configModel.baseUrls.restaurantImageUrl : Get.find<SplashController>().configModel.baseUrls.deliveryManImageUrl}/${_takeAway ? track.restaurant.logo : track.deliveryMan.image}',
                  height: 35,
                  width: 35,
                  fit: BoxFit.cover,
                )),
