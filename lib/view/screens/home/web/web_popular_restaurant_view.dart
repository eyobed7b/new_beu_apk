      ...
      children: [
        ...
        _restaurantList != null
            ? GridView.builder(
                ...
                itemCount:
                    _restaurantList.length > 5 ? 6 : _restaurantList.length,
                      ...
                      child: Column(
                          ...
                          children: [
                            Stack(children: [
                              ...
                              DiscountTag(
                                discount: _restaurantList[index].discount !=
                                        null
                                    ? _restaurantList[index].discount.discount
                                    : 0,
                                      ...
                                      if (Get.find<AuthController>()
                                        ...
                                        _isWished
                                            ? wishController.removeFromWishList(
                                                _restaurantList[index].id, true)
                                            : wishController.addToWishList(null,
                                                _restaurantList[index], true);
                                      } else {
                                        showCustomSnackBar(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      ...
                                      RatingBar(
                                        rating:
                                            _restaurantList[index].avgRating,
                                        ratingCount:
                                            _restaurantList[index].ratingCount,
                                        size: 15,
                                      ),
                                    ]),
                              ),
