    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Text('campaigns'.tr, style: sfMedium.copyWith(fontSize: 24)),
        ),
            ...
            ? GridView.builder(
                ...
                itemBuilder: (context, index) {
                  bool _isAvailable = DateConverter.isAvailable(
                        campaignController
                            .itemCampaignList[index].availableTimeStarts,
                        campaignController
                            .itemCampaignList[index].availableTimeEnds,
                      ) &&
                      DateConverter.isAvailable(
                        campaignController
                            .itemCampaignList[index].restaurantOpeningTime,
                        campaignController
                            .itemCampaignList[index].restaurantClosingTime,
                      );
