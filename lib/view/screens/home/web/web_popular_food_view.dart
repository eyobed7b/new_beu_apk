...
class WebPopularFoodView extends StatelessWidget {
  ...
  WebPopularFoodView(
      {@required this.productController, @required this.isPopular});

  @override
  Widget build(BuildContext context) {
    List<Product> _foodList = isPopular
    ...
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: Text(
              isPopular ? 'popular_foods_nearby'.tr : 'best_reviewed_food'.tr,
              style: sfMedium.copyWith(fontSize: 24)),
        ),
        _foodList != null
            ? GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  if (_foodList[index].choiceOptions.length != 0) {
                    ...
                    _foodList[index].variations.forEach(
                        (variation) => _priceList.add(variation.price));
                  ...
                  return InkWell(
                    onTap: () {
                      ResponsiveHelper.isMobile(context)
                          ? Get.bottomSheet(
                              ProductBottomSheet(
                                  product: _foodList[index], isCampaign: false),
                          ...
                          child: Padding(
                            ...
                            child: Column(
                                ...
                                children: [
                                  ...
                                  RatingBar(
                                    rating: _foodList[index].avgRating,
                                    size: 15,
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      SizedBox(
                                          width: _foodList[index].discount > 0
                                              ? Dimensions
                                                  .PADDING_SIZE_EXTRA_SMALL
                                              : 0),
                                      _foodList[index].discount > 0
                                          ? Expanded(
                                              child: Text(
                                              PriceConverter.convertPrice(
                                                  _startingPrice,
