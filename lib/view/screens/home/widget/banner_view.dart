...
class BannerView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      height:
          GetPlatform.isDesktop ? 500 : MediaQuery.of(context).size.width * 0.4,
                ...
                Expanded(
                  child: CarouselSlider.builder(
                    ...
                    itemBuilder: (context, index, _) {
                      String _baseUrl = bannerController.bannerDataList[index]
                          ...
                          child: ClipRRect(
                            ...
                            child: GetBuilder<SplashController>(
                              builder: (splashController) {
                                return CustomImage(
                                  image:
                                      '${bannerController.bannerImageList[index]}',
                                  fit: BoxFit.cover,
                                );
                              },
                            ),
