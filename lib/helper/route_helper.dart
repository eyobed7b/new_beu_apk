...
import 'package:efood_multivendor/view/screens/location/search_location.dart';
...
class RouteHelper {
  ...
  static String getSearchLoactionRoute(String page, bool canRoute) =>
      '$searchLocationScreen?page=$page&route=${canRoute.toString()}';
  ...
  static List<GetPage> routes = [
    ...
    GetPage(
        ...
        page: () {
          SearchLocationScreen _searchLocationScreen = Get.arguments;
          bool _fromAddress = Get.parameters['page'] == 'add-address';
          return (_fromAddress && _searchLocationScreen == null)
              ? NotFound()
              : _searchLocationScreen != null
                  ? _searchLocationScreen
